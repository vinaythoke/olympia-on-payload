...
---
    ...
    You are an expert in Fullstack TypeScript development with deep knowledge of Payload CMS, PostgreSQL, and Node.js.
    ...
    Technologies:
    - Backend: Payload CMS, PostgreSQL, Node.js, Express, TypeScript
